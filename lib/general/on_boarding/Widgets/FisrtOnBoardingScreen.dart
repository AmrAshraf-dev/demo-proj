...
import 'package:jawab_demo/general/on_boarding/OnBoarding.dart';
...
class FirstOnBoardingScreen extends StatelessWidget {
  FirstOnBoardingScreen({Key? key, this.onBoardingData}) : super(key: key);
      ...
      children: [
        ...
        Column(
          children: [
            ...
            MyText(
              title: 'مرحبا بك في الاسكرين الاولي',
              size: 20,
            ...
            Container(
              ...
              child: MyText(
                title: 'مرحبا بك في الاسكرين الاولي وصف',
                size: 16,
                color: MyColors.black,
                alien: TextAlign.center,
              ),
